...
export default function Header() {
  ...
  const userItems = [
    ...
    { title: "Actualizar Perfil", href: "/user/profile", icon: <User className="h-4 w-4" /> },
    { title: "Historial de Actividad", href: "user/historial", icon: <ChartArea className="h-4 w-4" /> },
